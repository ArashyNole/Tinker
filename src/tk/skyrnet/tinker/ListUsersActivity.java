...
public class ListUsersActivity extends ListActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
    	...
    	case R.id.profile:
    		Toast.makeText(ListUsersActivity.this, "My Profile", Toast.LENGTH_SHORT).show();
    		UserDetailsActivity.viewingUser = ParseUser.getCurrentUser();
    		startDetailsActivity();
            return true;
    	case R.id.userlist:
			Toast.makeText(ListUsersActivity.this, "Saved User List", Toast.LENGTH_SHORT).show();
			startSavedListActivity();
			return true;
    	case R.id.edit:
    		Toast.makeText(ListUsersActivity.this, "Edit Profile", Toast.LENGTH_SHORT).show();
    		startEditActivity();
            return true;
		case R.id.find:
			Toast.makeText(ListUsersActivity.this, "Loading User", Toast.LENGTH_SHORT).show();
			findUser();
			return true;
		case R.id.chat:
			Toast.makeText(ListUsersActivity.this, "Chat", Toast.LENGTH_SHORT).show();
			return true;
		}
        return false;
    }
